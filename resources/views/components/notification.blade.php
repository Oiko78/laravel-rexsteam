@if (session('success'))
    <div x-data="flash_message" x-show="open" x-on:click.outside="open = !open " x-init="setTimeout(() => open = false, 2000)"
         class="absolute left-1/2 top-5 z-10 flex w-4/5 -translate-x-1/2 rounded-lg bg-green-100 p-4 drop-shadow-lg dark:bg-green-200 sm:w-4/5 lg:w-3/5 xl:w-2/3">
...
@else
    <div x-data="flash_message" x-show="open" x-on:click.outside="open = !open " x-init="setTimeout(() => open = false, 2000)"
         class="absolute left-1/2 top-5 z-10 flex w-4/5 -translate-x-1/2 rounded-lg bg-red-100 p-4 drop-shadow-lg dark:bg-red-200 sm:w-4/5 lg:w-3/5 xl:w-2/3">
